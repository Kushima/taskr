...
export class TodosComponent implements OnInit {
    ...
    newOrEditTask: Story = { _id: null, name: null, order: null, _sprintId: null };
    ...
    addTask(): void {
        this.storyService.create(this.newOrEditTask)
            .then(
            story => {
                this.stories.push(story);

                this.resetNewOrEditTask();
            });
    }
    ...
    editContainer(container: Todo): void {
        this.isEditingContainer = true;
        this.newOrEditContainer = container;
    }

    saveContainer(): void {
        this.todoService
            .update(this.newOrEditContainer);
    }

    editTask(task: Story): void {
        this.isEditingTask = true;
        this.newOrEditTask = task;
    }

    saveTask(): void {
        this.storyService
            .update(this.newOrEditTask);
    }
    ...
    resetNewOrEditTask(): void {
        this.newOrEditTask = { _id: null, name: null, order: null, _sprintId: null };
    }
}
